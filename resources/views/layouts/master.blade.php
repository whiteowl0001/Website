                    ...
                    <li class="hidden">
                     ...
                     <li class="page-scroll">
                         <div class="btn-group open">
                            <a class="btn btn-primary" href="/mybiz">Home</a>
                     ...
                     <li class="page-scroll">
                         <div class="btn-group open">
                            <a class="btn btn-primary" href="/portfolio">About</a>
                            <a class="btn btn-primary dropdown-toggle" data-toggle="dropdown" href="#">
                                <span class="fa fa-caret-down" title="Toggle dropdown menu"></span>
                            </a>
                        </div>
                     ...
                     <li class="page-scroll">
                         <div class="btn-group open">
                            <a class="btn btn-primary" href="/portfolio">Services</a>
                            <a class="btn btn-primary dropdown-toggle" data-toggle="dropdown" href="#">
                                <span class="fa fa-caret-down" title="Toggle dropdown menu"></span>
                            </a>
                        </div>
                     ...
                     <li class="page-scroll">
                         <div class="btn-group open">
                            <a class="btn btn-primary" href="/superformance">Contact</a>
                            <a class="btn btn-primary dropdown-toggle" data-toggle="dropdown" href="#">
                                <span class="fa fa-caret-down" title="Toggle dropdown menu"></span>
                            </a>
                        </div>
